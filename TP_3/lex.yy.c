...
YY_RULE_SETUP
#line 18 "TP3.l"
{printf("Encontre la constante entera decimal que tiene como primer caracter: %s \n",yytext);}
	YY_BREAK
case 2:
YY_RULE_SETUP
#line 19 "TP3.l"
{printf("Encontre la constante entera octal que tiene como segundo caracter: %s \n",yytext);}
	YY_BREAK
case 3:
YY_RULE_SETUP
#line 20 "TP3.l"
