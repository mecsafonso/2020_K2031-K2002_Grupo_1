...
/* Line 1455 of yacc.c  */
#line 155 "TP4Bison.y"
    {fprintf(archivoFinal,"Se encontró el desarrollo de la función %s", (yyvsp[(2) - (3)].cadena));memset(tipo, 0, 30);;}
    break;
...
/* Line 1455 of yacc.c  */
#line 180 "TP4Bison.y"
    {agregar_validaciones_sintacticas(&listaDeValidacionesSintacticas, numeroDeLinea , "de ASIGNACIÓN");;}
    break;
